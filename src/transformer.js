...
const KEYWORD_TRANSFORMS = [
  ...
  { match: "실행", replacement: "do", requiresBoundary: true },
  ...
  { match: "에서", replacement: "from", requiresBoundary: true },
  { match: "프롬", replacement: "from", requiresBoundary: true },
  { match: "오브", replacement: "of", requiresBoundary: true },
  { match: "안에", replacement: "in", requiresBoundary: true },
  { match: "내보내기", replacement: "export", requiresBoundary: true },
  { match: "스위치", replacement: "switch", requiresBoundary: true },
  { match: "선택", replacement: "switch", requiresBoundary: true },
  { match: "케이스", replacement: "case", requiresBoundary: true },
  { match: "경우", replacement: "case", requiresBoundary: true },
  { match: "디폴트", replacement: "default", requiresBoundary: true },
  { match: "기본", replacement: "default", requiresBoundary: true },
  { match: "중단", replacement: "break", requiresBoundary: true },
  { match: "멈춤", replacement: "break", requiresBoundary: true },
  { match: "계속", replacement: "continue", requiresBoundary: true },
  { match: "마침내", replacement: "finally", requiresBoundary: true },
  ...
  { match: "열거형", replacement: "enum", requiresBoundary: true },
  { match: "클래스", replacement: "class", requiresBoundary: true },
  { match: "추상", replacement: "abstract", requiresBoundary: true },
  { match: "공개", replacement: "public", requiresBoundary: true },
  { match: "보호", replacement: "protected", requiresBoundary: true },
  { match: "비공개", replacement: "private", requiresBoundary: true },
  { match: "정적", replacement: "static", requiresBoundary: true },
  { match: "읽기전용", replacement: "readonly", requiresBoundary: true },
  { match: "얻기", replacement: "get", requiresBoundary: true },
  { match: "설정", replacement: "set", requiresBoundary: true },
  { match: "선언", replacement: "declare", requiresBoundary: true },
  { match: "생성자", replacement: "constructor", requiresBoundary: true },
  { match: "상위", replacement: "super", requiresBoundary: true },
  ...
  { match: "양보", replacement: "yield", requiresBoundary: true },
  { match: "삭제", replacement: "delete", requiresBoundary: true },
  { match: "타입오브", replacement: "typeof", requiresBoundary: true },
  { match: "키오브", replacement: "keyof", requiresBoundary: true },
  { match: "인퍼", replacement: "infer", requiresBoundary: true },
  { match: "만족", replacement: "satisfies", requiresBoundary: true },
  { match: "애즈", replacement: "as", requiresBoundary: true },
  { match: "처럼", replacement: "as", requiresBoundary: true },
  { match: "이즈", replacement: "is", requiresBoundary: true },
  { match: "이다", replacement: "is", requiresBoundary: true },
  { match: "무효", replacement: "void", requiresBoundary: true },
